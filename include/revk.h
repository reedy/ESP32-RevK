...
const char *revk_settings (jo_t,const char**);        // Store settings, return error (set location in j of error, valid while j valid)
#define	revk_setting(j) revk_settings(j,NULL);
